					...
					<div class="col-md-12">
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								<form method="post" class="form-horizontal" action="<?php echo site_url('module_contract/admin_functions/contract/'.$this->input->get('action').'/'.$this->input->get('contract_id')); ?>" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											?>
											<input type="text" class="form-control" placeholder="Approval" value="<?php echo $contract_approval_select_name; ?>" onfocus="blur();" required />
											<?php
												}
											?>
										</div>
									...
									<div class="form-group">
										<div class="col-md-9 col-md-offset-3">
											...
											<button class="btn btn-white" type="button" onclick="window.location.href='<?php echo site_url('module_contract/admin/proses_kontrak_utama/'); ?>'">Kembali</button>
										</div>
									</div>
								</form>
							</div>
				...
				<script type="text/javascript">
					...
					$("#contract_request_id").change(function(){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_contract/admin_functions/get_dropdown_request_description/",
					...
					$("#contract_request_description_id").change(function(){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_contract/admin_functions/get_input_document/",
							success: function(result){
								var data = JSON.parse(result);
					...
					$("#contract_project_code_category").change(function(){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_contract/admin_functions/get_dropdown_project_code/",
							success: function(result){
								var data = JSON.parse(result);
					...
					$("#contract_project_code_id").change(function(){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_contract/admin_functions/get_form_project_code_detail/",
							success: function(result){
								var data = JSON.parse(result);
					...
					$("#contract_date_start").change(function(){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_contract/admin_functions/get_form_project_code_period/",
							success: function(result){
								var data = JSON.parse(result);
					...
					$("#contract_project_currency").change(function(){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_contract/admin_functions/get_form_project_calculate/",
							success: function(result){
								var data = JSON.parse(result);
					...
					$(document).on('click','#delete',function(e){
						...
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_contract/admin_functions/contract_attachment/delete/",
							success: function(result){
								$('#confirm').modal('hide');
						...
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								...
								<div class="row form-horizontal">
									...
									<div class="col-md-6">
										<form method="post" id="form-approval" action="<?php echo site_url('module_contract/admin_functions/contract_approval/'.$this->input->get('contract_id')); ?>" enctype="multipart/form-data">
											<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" required />
											<?php
				...
				<script type="text/javascript">
					...
					$("#template_id").change(function(){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_contract/admin_functions/get_form_template_file/",
							success: function(result){
								var data = JSON.parse(result);
					...
					$("#contract_process_id").change(function(){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_contract/admin_functions/get_form_contract_process/",
							success: function(result){
								var data = JSON.parse(result);
						...
						if($("#contract_status_process").val() == 'Approved' || $("#contract_status_process").val() == 'Done'){
							...
							// $.ajax({
								...
								// data: {
									...
									// "<?php echo $this->security->get_csrf_token_name(); ?>": '<?php echo $this->security->get_csrf_hash(); ?>'
								// },
								// url: "<?php echo site_url(); ?>module_contract/admin_functions/get_dropdown_sign_speciment/",
								// success: function(result){
									// var data = JSON.parse(result);
									// if(data['status'] == true){
					...
					$("#contract_summary_file_name").change(function(){
						...
						$.ajax({
							...
							processData: false,
							contentType: false,
							url: "<?php echo site_url(); ?>module_contract/admin_functions/get_form_contract_upload/",
							beforeSend: function(){
					...
					$("#contract_ttd_sign_speciment").change(function(){
						if($("#contract_ttd_sign_speciment").val() != null){
							$.ajax({
								...
								url: "<?php echo site_url(); ?>module_contract/admin_functions/get_input_sign_digital/",
								success: function(result){
									var data = JSON.parse(result);
					...
					function onSign()
					{
						if($("#contract_ttd_sign_type").val() == 'Digital'){
							var url = '<?php echo site_url(); ?>module_contract/admin_functions/contract_sign/<?php echo $contract_id; ?>/' + $("#contract_ttd_sign_speciment").val() + '?time=<?php echo date("YmdHis"); ?>';
						}else if($("#contract_ttd_sign_type").val() == 'Digital+Sertifikasi'){
							var url = '<?php echo site_url(); ?>module_contract/admin_functions/contract_sign_certification/<?php echo $contract_id; ?>/' + $("#contract_ttd_sign_speciment").val() + '?time=<?php echo date("YmdHis"); ?>';
						}
					...
					function checkTrigger()
					{
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_contract/admin_functions/get_input_trigger/",
							success: function(result){
								var data = JSON.parse(result);
								if(data['trigger'] == 'yes'){
									$("#submit-btn").prop('disabled', false);
				...
				<script type="text/javascript">
					...
					table = $('#table').DataTable({
						...
						"order": [],
						"ajax": {
							"url": "<?php echo site_url('module_contract/admin_functions/get_table_process_contract_project/')?>",
							"data": {
								"<?php echo $this->security->get_csrf_token_name(); ?>": '<?php echo $this->security->get_csrf_hash(); ?>'
							},
							"type": "POST"
					...
					$(document).ready(function () {
						...
						$('#delete').click(function() {
							window.location = '<?php echo site_url(); ?>module_contract/admin_functions/contract/delete/' + $('#id').val();
						});
					});
