					...
					<div class="col-md-12">
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								<form method="post" class="form-horizontal" action="<?php echo site_url('module_procurement/employee_functions/request/'.$this->input->get('action').'/'.$this->input->get('request_id').'/'); ?>" enctype="multipart/form-data">
				...
				<script type="text/javascript">
					...
					$(document).ready(function () {
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_procurement/employee_functions/get_input_employee/",
					...
					$("#request_pic_contract_id").change(function(){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_procurement/employee_functions/get_dropdown_approval_contract/",
							success: function(result){
								var data = JSON.parse(result);
								$("#request_pic_contract_approval_id").val('').trigger('change');
					...
					$("#request_pic_contract_request_id").change(function(){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_procurement/employee_functions/get_dropdown_request_description/",
							success: function(result){
								var data = JSON.parse(result);
					...
					$("#cost_category_id").change(function(){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_procurement/employee_functions/get_dropdown_type_code/",
							success: function(result){
								var data = JSON.parse(result);
					...
					function onItem(obj){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_procurement/employee_functions/get_input_item/",
							success: function(result){
								var data = JSON.parse(result);
					...
					$(document).on('click','#delete',function(e){
						...
						if($('#from').val() == 'det'){
							...
							$.ajax({
								...
								url: "<?php echo site_url(); ?>module_procurement/employee_functions/request_det/delete/",
								success: function(result){
									$('#confirm').modal('hide');
							...
							$.ajax({
								...
								url: "<?php echo site_url(); ?>module_procurement/employee_functions/request_attachment/delete/",
								success: function(result){
									$('#confirm').modal('hide');
									$('#modal_detail').modal('show');
									$('.isi').html(''
							...
							<div class="ibox-content">
								<div class="form-horizontal">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<form method="post" class="form-horizontal" action="<?php echo site_url('module_procurement/employee_functions/request_approval/'.$this->input->get('request_id').'/'); ?>" enctype="multipart/form-data">
												<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" required />
												<?php
												...
												<div class="form-group">
													<div class="col-md-9 col-md-offset-3">
														<button class="btn btn-primary" type="submit">Simpan</button>
														<button class="btn btn-white" type="button" onclick="window.location.href='<?php echo site_url('module_procurement/employee/proses_permintaan/'); ?>'">Kembali</button>
													</div>
												</div>							
											</form>
										</div>
							...
							<div class="ibox-content">
								<div class="form-horizontal">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<form method="post" class="form-horizontal" action="<?php echo site_url('module_procurement/employee_functions/request_mapping/'.$this->input->get('request_id').'/'); ?>" enctype="multipart/form-data">
												<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" required />
												<div class="form-group">
													<div class="col-md-12">
						...
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								<div class="form-horizontal">
									...
									<div class="form-group">
										<div class="col-md-9 col-md-offset-3">
											<button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal_edit_user_docs">
												<i class="fa fa-edit"></i> Ubah Dokumen Pendukung & Deskripsi
											</button>
											<small class="text-muted" style="margin-left:8px;">Anda dapat memperbarui dokumen pendukung dan deskripsi saat status Process Procurement.</small>
										</div>
									</div>
									<div class="hr-line-dashed"></div>
									<h4>Proses Pengadaan</h4>
				...
				<div class="modal fade" id="modal_process_attach">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="post" class="form-horizontal" action="<?php echo site_url('module_procurement/employee_functions/request_process_attach/add/'.$this->input->get('request_id')); ?>" enctype="multipart/form-data">
									<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" required="">
				...
				<script type="text/javascript">
					...
					$(document).on('click','.add_vendor',function(e){
						...
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_procurement/employee_functions/get_input_request_legal/",
							success: function(result){
								var data = JSON.parse(result);
								...
								form_vendor.action = '<?php echo site_url('module_procurement/employee_functions/request_vendor/add/'.$this->input->get('request_id').'/'); ?>';
							}
						});
					});
					...
					$(document).on('click','.edit_vendor',function(e){
						...
						$.ajax({
							...
							success: function(result){
								...
								const form_vendor = document.getElementById('form-vendor');
								form_vendor.action = '<?php echo site_url('module_procurement/employee_functions/request_vendor/edit/'); ?>' + id;
							}
						});
					});
					...
					$(document).on('click','.process_vendor',function(e){
						...
						table = $('#table-document').DataTable({
							...
							"order": [],
							"ajax": {
								"url": "<?php echo site_url('module_procurement/employee_functions/get_table_request_process_attach/')?>",
								"data": {
									"request_legal_id" : id,
									"<?php echo $this->security->get_csrf_token_name(); ?>": '<?php echo $this->security->get_csrf_hash(); ?>'
								},
						...
						table = $('#table-official').DataTable({
							...
							"order": [],
							"ajax": {
								"url": "<?php echo site_url('module_procurement/employee_functions/get_table_official/')?>",
								"data": {
									"request_legal_id" : id,
									"<?php echo $this->security->get_csrf_token_name(); ?>": '<?php echo $this->security->get_csrf_hash(); ?>'
								},
					...
					$("#process_proc_id").change(function(){
						$.ajax({
							...
							url: "<?php echo site_url(); ?>module_procurement/employee_functions/get_input_official/",
							success: function(result){
								var data = JSON.parse(result);
								if(data['status'] == 'true'){
									$("#for-winner").show();
					...
					$(document).ready(function () {
						...
						$('#delete').click(function() {
							if($('#from').val() == 'vendor'){
								window.location = '<?php echo site_url(); ?>module_procurement/employee_functions/request_vendor/delete/' + $('#id').val();
							}else if($('#from').val() == 'attach'){
								window.location = '<?php echo site_url(); ?>module_procurement/employee_functions/request_process_attach/delete/' + $('#id').val();
							}
						});
					});
				...
				<script type="text/javascript">
					...
					table = $('#table').DataTable({
						...
						"order": [],
						"ajax": {
							"url": "<?php echo site_url('module_procurement/employee_functions/get_table_request_process/')?>",
							"data": {
								"<?php echo $this->security->get_csrf_token_name(); ?>": '<?php echo $this->security->get_csrf_hash(); ?>'
							},
							"type": "POST"
					...
					$(document).ready(function () {
						...
						$(document).on('click','.cancel',function(e){
							...
							$.ajax({
								...
								url: "<?php echo site_url(); ?>module_procurement/employee_functions/get_modal_cancel/",
								success: function(result){
									var data = JSON.parse(result);
									$(".isi").html(data['isi']);
								}
						...
						$(document).on('click','.finish',function(e){
							...
							$.ajax({
								...
								url: "<?php echo site_url(); ?>module_procurement/employee_functions/get_modal_finish/",
								success: function(result){
									var data = JSON.parse(result);
									$('.isi').html(data['isi']);
								}
						...
						$('#delete').click(function() {
							if($('#from').val() == 'undo'){
								window.location = '<?php echo site_url(); ?>module_procurement/employee_functions/request_undo/' + $('#id').val();
							}else if($('#from').val() == 'delete'){
								window.location = '<?php echo site_url(); ?>module_procurement/employee_functions/request/delete/' + $('#id').val();
							}
						});
						...
						$(document).on('click', '.btn-doc-history', function(){
							...
							$.ajax({
								type: 'GET',
								url: '<?php echo site_url(); ?>module_procurement/employee_functions/get_document_history',
								data: {
				...
				<div class="modal fade" id="modal_edit_user_docs" tabindex="-1" role="dialog">
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							<form method="post" class="form-horizontal" action="<?php echo site_url('module_procurement/employee_functions/request_edit_process/'.$this->input->get('request_id')); ?>" enctype="multipart/form-data">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal">&times;</button>
									<h4 class="modal-title">Ubah Dokumen Pendukung & Deskripsi</h4>
								</div>
								<div class="modal-body">
									<p class="text-info">Unggah ulang dokumen (opsional per baris) — versi lama otomatis disimpan ke riwayat. Deskripsi wajib diisi.</p>
									<?php
										unset($datato);
										$datato['table'] = 'patlog__procurement.entity__request_document';
										$datato['where'] = array(
										...
										$datato['order'] = array('patlog__procurement.entity__request_document.request_document_order');
										$datato['order_type'] = array('asc');
										$Q_ud = $this->view->view_data($datato);
										$__ud_i = 0;
										foreach($Q_ud->result() as $R_ud){
									?>
									<div class="form-group">
										<label class="col-md-4 control-label"><?php echo $R_ud->request_document_name; ?></label>
										<div class="col-md-8">
											<input type="hidden" name="request_document_id[<?php echo $__ud_i; ?>]" value="<?php echo $R_ud->request_document_id; ?>" />
											<input type="file" class="form-control" name="request_document_file[<?php echo $__ud_i; ?>]" accept="<?php echo $R_ud->request_document_mimes; ?>" />
											<?php if($R_ud->request_document_file != 'no.pdf'){ ?>
											<small class="text-muted">File saat ini: <a href="<?php echo base_url('assets/mod__procurement/attach/request-document-file/'.$R_ud->request_document_file); ?>" target="_blank"><?php echo $R_ud->request_document_file; ?></a></small>
											<?php } ?>
										</div>
									</div>
									<?php
									...
									<div class="hr-line-dashed"></div>
									<div class="form-group">
										<label class="col-md-4 control-label">Deskripsi <span class="text-danger">*</span></label>
										<div class="col-md-8">
											<textarea class="form-control" name="request_note" placeholder="Deskripsi / Catatan Pekerjaan" rows="4" maxlength="1000" required><?php echo $request_note; ?></textarea>
										</div>
									</div>
								</div>
								<div class="modal-footer">
